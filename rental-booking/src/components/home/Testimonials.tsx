...
const TestimonialSlider = ({ testimonials }: TestimonialProps) => {
    ...
    return (
        <div className="xl:px-60 lg:px-40 md:px-12 px-4 flex flex-col items-center py-10 bg-white relative mt-10">
            ...
            <div className='absolute md:bottom-9 bottom-6 md:left-[40.5%] left-[24%] flex space-x-2'>
                {
