...
const TestimonialSliderComponent: React.FC<Testimonial> = ({  testimonial, name, role }) => {
    return (
        <div className="flex  space-x-5">
            <div className='relative w-24 md:w-36 h-20 md:h-36'>
                <img src={'/images/testimonial.png'} className="w-full h-full object-cover rounded-full" alt={name} />
